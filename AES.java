...
public class AES {
	private static String encriptar(String texto, String chave) throws Exception{
		...
		IvParameterSpec objIv = new IvParameterSpec("Junior e Bonitao".getBytes("UTF-8"));// 16 caracteres, caracter especial conta 2 bytes
		objCifra.init(Cipher.ENCRYPT_MODE, objChave, objIv);// e a chave tem que ter 32 letras na hora de digitar
